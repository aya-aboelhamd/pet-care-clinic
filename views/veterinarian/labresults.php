        ...
        <div class="content-padding">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <i class="fa-solid fa-flask icon-critical"></i>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>2026-04-10</td>
                            <td>WBC 8.5 / RBC 6.2 / HGB 14.1</td>
                            <td><span class="badge badge-normal">Normal</span></td>
                            <td style="text-align: right;"><button class="view-btn">View</button></td>
                        </tr>
                        <tr>
                            <td><div class="pet-cell">🐕 Max</div></td>
                            <td>Hip X-Ray</td>
                            <td>2026-04-10</td>
                            <td>Mild left hip subluxation</td>
                            <td><span class="badge badge-abnormal">Abnormal</span></td>
                            <td style="text-align: right;"><button class="view-btn">View</button></td>
                        </tr>
                        <tr>
