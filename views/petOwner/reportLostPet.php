...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .btn-submit { background: var(--primary-green); color: white; border: none; padding: 14px; border-radius: 8px; font-weight: 700; cursor: pointer; width: 100%; font-size: 0.95rem; transition: 0.3s; }
        .btn-submit:hover { background: #467B50; transform: translateY(-1px); }
    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-profile" style="display: flex; align-items: center; gap: 12px;">
                ...
                <div style="width: 32px; height: 32px; background: var(--primary-green); color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.8rem;">SJ</div>
                <div style="font-size: 0.85rem;"><strong>Sarah Johnson</strong></div>
            </div>
        </header>
                ...
                <div class="form-col">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                ...
                                <select class="form-select">
                                    ...
                                    <option>Not Registered / Other</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Collar / Harness Color</label>
                                <input type="text" class="form-input" placeholder="e.g. Red leather collar">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Distinctive Features</label>
                            <textarea class="form-textarea" placeholder="Describe unique marks, behavior, or medical needs..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="e.g. Central Park West Entrance">
                        </div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <div style="position: relative; display: flex; align-items: center;">
                                ...
                                <input type="number" class="form-input" style="padding-left: 28px;" placeholder="0.00">
                            </div>
                        </div>
                        <button type="submit" class="btn-submit">Launch Alert Now</button>
