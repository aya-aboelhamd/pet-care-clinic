...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .btn-invite { background: var(--primary-green); color: white; border: none; padding: 10px 20px; border-radius: 8px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 10px; font-size: 0.85rem; }
        ...
        td { padding: 15px; font-size: 0.9rem; border-bottom: 1px solid var(--border-color); }
        ...
        .btn-edit { background: none; border: 1px solid var(--border-color); padding: 5px 15px; border-radius: 6px; cursor: pointer; font-size: 0.8rem; font-weight: 500; }
        .btn-suspend { background: none; border: 1px solid #FFEBEE; color: var(--danger-red); padding: 5px 15px; border-radius: 6px; cursor: pointer; font-size: 0.8rem; font-weight: 500; }
        .btn-suspend:hover { background: #FFEBEE; }
        ...
        <div class="content-padding">
            <div class="page-header">
                <div>
                    ...
                    <p>View, suspend or promote platform users.</p>
                </div>
            ...
            <div class="search-container">
                ...
                <input type="text" class="search-bar" placeholder="Search by name, email or role...">
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span class="badge-role role-owner">owner</span></td>
                        ...
                        <tr>
                            <td><strong>Dr. Mark Lee</strong></td>
                            <td>vet@petlor.com</td>
                            <td><span class="badge-role role-vet">vet</span></td>
                            <td><span class="status-pill">Active</span></td>
                            <td align="right">
                                <div class="action-cell" style="justify-content: flex-end;">
                                    <button class="btn-edit">Edit</button>
                        ...
                        <tr>
                            <td><strong>Bella Walks Co.</strong></td>
                            <td>provider@petlor.com</td>
                            <td><span class="badge-role role-provider">provider</span></td>
                            <td><span class="status-pill">Active</span></td>
                            <td align="right">
                                <div class="action-cell" style="justify-content: flex-end;">
                                    <button class="btn-edit">Edit</button>
